    ...
    <div className="flex flex-col space-y-7 mt-4">
      ...
      <div className="flex flex-row space-x-10 items-center justify-between">
        <div className="flex flex-row ml-3 space-x-2 items-center">
          ...
          <label htmlFor="remember" className="text-foreground/60">
            Remember me
          </label>
        </div>
        <button className="font-semibold text-sm bg-linear-to-r bg-clip-text text-transparent from-foreground/80 via-foreground/50 to-foreground/40 hover:bg-foreground/30 cursor-pointer transition-all duration-100">
          Forgot Password?
        </button>
      </div>
